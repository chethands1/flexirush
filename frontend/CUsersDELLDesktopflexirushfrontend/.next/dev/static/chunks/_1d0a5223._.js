...
function useRealtime(sessionCode, myName) {
    ...
    // Grab setters (These are stable and won't cause re-renders)
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useRealtime.useEffect": ()=>{
            // 1. Safety Check: 
            // If myName is explicitly NULL, it means we are "Waiting to Join". Do not connect yet.
            if (!sessionCode || sessionCode === "undefined" || myName === null) {
                return;
            }
            const connect = {
                "useRealtime.useEffect.connect": ()=>{
                    if (reconnectTimeout.current) clearTimeout(reconnectTimeout.current);
                    // If myName is undefined, default to 'presenter'. If it's a string, encode it.
                            ...
                            try {
                                ...
                                switch(data.type){
                                    ...
                                    case 'BRANDING_UPDATE':
                                        ...
                                        break;
                                    case 'QUIZ_UPDATE':
                                        setQuiz(data.quiz || data.payload);
        ...
        // PATCH: Dependency array MINIMIZED. 
        // We removed 'participants', 'quiz', etc. to stop the infinite reconnect loop.
        }
    }["useRealtime.useEffect"], [
        sessionCode,
        myName,
...
function AudiencePage({ params }) {
    ...
    const { currentPoll, questions, isConnected, quiz, setBranding, branding } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$sessionStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSessionStore"])();
    // Local State
    const [name, setName] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [userId, setUserId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(""); // PATCH: Store the unique ID from backend
    ...
    // --- CONNECT WEBSOCKET ---
    // PATCH: We pass 'null' (or undefined) if we haven't joined yet.
    // This prevents the "403 Forbidden" loop because we only connect once we have the valid 'userId'.
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AudiencePage.useEffect": ()=>{
            fetch(`http://localhost:8001/api/session/${code}/state`).then({
                ...
                "AudiencePage.useEffect": ()=>{
                // Optional: Redirect if session is invalid
                // router.push("/"); 
                }
            }["AudiencePage.useEffect"]);
        }
    ...
    const handleJoin = async ()=>{
        ...
        try {
            ...
            if (res.ok) {
                ...
                // PATCH: Capture the unique ID (uuid) generated by the backend
                // We MUST use this ID for the WebSocket, or the backend will return 403.
    ...
    if (quiz && quiz.state !== "END") {
        // PATCH: We use `key` to force re-render when current_index changes, resetting "answered" state.
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: activeTab === "poll" ? !currentPoll ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    lineNumber: 183,
                    columnNumber: 13
                }, this) : // PATCH: Force re-render on new poll to reset local state
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(PollView, {
                    poll: currentPoll,
                    code: code
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: questions.filter((q)=>q.visible !== false).length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(AudiencePage, "B86VYyClBpo1FeCHTjDsIk+GEuw=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$sessionStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSessionStore"],
...
//# sourceMappingURL=_1d0a5223._.js.map